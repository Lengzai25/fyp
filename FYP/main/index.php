...
<!-- Mirrored from storage.googleapis.com/theme-vessel-items/checking-sites-2/wain-html/HTML/main/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Dec 2024 12:34:23 GMT -->
<head>
    <!-- Google Tag Manager -->
                    ...
                    <div class="carousel-content container">
                        <div class="text-left max-w">
                            ...
                            <p data-animation="animated fadeInUp delay-10s">
                                This is Car Dealer website template based on Bootstrap 4 framework.
                            </p>
...
<div class="featured-car content-area-2 bg-grea">
    <div class="container">
        <div class="main-title">
            <h1><span>Featured</span> Vehicles</h1>
                    ...
                    <div class="car-box-4">
                        ...
                        <div class="car-thumbnail">
                            <a href="car-details.html" class="car-img">
                                <img src="assets/img/car-list-1.jpg" alt="car-list" class="img-fluid">
                            </a>
                            <div class="car-overlay">
                                ...
                                <div class="car-magnify-gallery">
                                    <a href="assets/img/car-1.jpg" class="overlay-link">
                                        <i class="fa fa-expand"></i>
                                    </a>
                                    <a href="assets/img/car-6.jpg" class="hidden"></a>
                                    <a href="assets/img/car-4.jpg" class="hidden"></a>
                                </div>
                            </div>
                            <div class="text">
                    ...
                    <div class="car-box-4">
                        ...
                        <div class="car-thumbnail">
                            ...
                            <div class="car-overlay">
                                ...
                                <div class="car-magnify-gallery">
                                    <a href="assets/img/car-3.jpg" class="overlay-link">
                                        <i class="fa fa-expand"></i>
                                    </a>
                                    <a href="assets/img/car-6.jpg" class="hidden"></a>
                                    <a href="assets/img/car-4.jpg" class="hidden"></a>
                ...
                <div class="col-lg-5 col-md-12 col-pad wow fadeInRight delay-04s">
                    <div class="overview aa overview-box">
                        ...
                        <div class="mask">
                            <h2>Florida</h2>
                            <p>21 Car</p>
                            <a href="car-details.html" class="btn btn-border">Read more</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-pad wow fadeInUp delay-04s">
                            <div class="overview overview-box">
                                <img src="assets/img/latest-car/latest-car-2.jpg" alt="latest-car">
                                <div class="mask">
                                    <h2>Canada</h2>
                                    <p>25 Car</p>
                                    <a href="car-details.html" class="btn btn-border">Read more</a>
                        ...
                        <div class="col-md-6 col-sm-6 col-pad wow fadeInUp delay-04s">
                            <div class="overview overview-box">
                                <img src="assets/img/latest-car/latest-car-4.jpg" alt="latest-car">
                                <div class="mask">
                                    <h2>California</h2>
                                    <p>12 Car</p>
                                    <a href="car-details.html" class="btn btn-border">Read more</a>
                        ...
                        <div class="col-md-12 col-pad wow fadeInLeft delay-04s">
                            <div class="overview overview-box">
                                <img src="assets/img/latest-car/latest-car.jpg" alt="latest-car">
                                <div class="mask">
                                    <h2>New York</h2>
                                    <p>14 Car</p>
                                    <a href="car-details.html" class="btn btn-border">Read more</a>
            ...
            <div class="row slick-carousel" data-slick='{"slidesToShow": 2, "responsive":[{"breakpoint": 1024,"settings":{"slidesToShow": 2}}, {"breakpoint": 768,"settings":{"slidesToShow": 1}}]}'>
                <div class="slick-slide-item">
                    <div class="row blog-list">
                        <div class="col-lg-5 col-md-12 col-pad ">
                            <div class="photo">
                                <img src="assets/img/blog/blog-6.jpg" alt="blog-4" class="img-fluid fit-cover h-100">
                                <div class="date-box">
                                    <h5>03 Feb</h5>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-7 col-md-12 col-pad align-self-center">
                            <div class="detail">
                                <h3>
                                    <a href="blog-single-sidebar-right.html">Selling Your Awesome Car</a>
                                </h3>
                                <div class="post-meta">
                ...
                <div class="slick-slide-item">
                    <div class="row blog-list">
                        <div class="col-lg-5 col-md-12 col-pad ">
                            <div class="photo">
                                <img src="assets/img/blog/blog-5.jpg" alt="blog-5" class="img-fluid fit-cover h-100">
                                <div class="date-box">
                                    <h5>03 Feb</h5>
                                </div>
                            </div>
