...
<!-- Mirrored from techzaa.in/techmin/layouts/apps-invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Dec 2024 04:33:43 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Invoice | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">Invoice</h4>
        </div>
