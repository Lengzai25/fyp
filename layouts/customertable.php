...
<head>
    <meta charset="utf-8" />
    <title>Customer Tables | Admin Dashboard CARWOW</title>
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">Customer Tables</h4>
        </div>
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    if (isset($_POST["searchbtn"])) 
                                                    {
                                                        ...
                                                        $check_search = mysqli_query($conn, "SELECT * FROM customer WHERE cust_name = '$search'");
                                                ...
                                                <tr>
                                                    ...
                                                    <?php
                                                        ...
                                                        echo "<a href='customertable.php?del_cid=".$row['cust_id']."' ' onclick='return confirm_delete();'> <i
...
if (isset($_REQUEST["del_cid"]))
{
	...
	$cid = $_REQUEST["del_cid"]; 

	mysqli_query($conn, "delete from customer where cust_id = $cid");
