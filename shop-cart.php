        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <table class="shop-table cart mb-20">
                    ...
                    <tr>
                        <td class="product-thumbnail"><img src="assets/img/shop/shop-2.jpg" alt="shop-2"></td>
                        <td class="product-name">
                            <a href="#">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean ac tortor</a>
                        </td>
                        <td>£58.00</td>
                    ...
                    <tr>
                        <td class="product-thumbnail"><img src="assets/img/shop/shop-3.jpg" alt="shop-3"></td>
                    ...
                    <tr>
                        <td class="product-thumbnail"><img src="assets/img/shop/shop-4.jpg" alt="shop-4"></td>
                    ...
                    <tr>
                        <td class="product-thumbnail"><img src="assets/img/shop/shop-5.jpg" alt="shop-5"></td>
                    ...
                    <tr>
                        <td class="product-thumbnail"><img src="assets/img/shop/shop-1.jpg" alt="shop-6"></td>
                        <td class="product-name">
                            <a href="#">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean ac tortor</a>
                        </td>
                        <td>£58.00</td>
                    ...
                    <tr>
                        <td class="product-thumbnail"><img src="assets/img/shop/shop-5.jpg" alt="shop-7"></td>
            ...
            <div class="col-lg-4">
                <div class="cart-total-box bg-light hdn-mb-30 mb-30">
                    ...
                    <ul>
                        ...
                        <li>
                            Shipping Charge<span class="pull-right">$sub-property-234.00</span>
                        </li>
                        <li>
                            Local Delivery <span class="pull-right">$334</span>
                        </li>
                        <li>
                            Flat Rate<span class="pull-right">$1sub-property-234</span>
                        </li>
                        <li>
                            International<span class="pull-right">$65sub-property-2</span>
                        </li>
                    </ul>
                    <hr>
                    <p class="mar-b-50">
